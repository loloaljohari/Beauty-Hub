...
class pageAddpost extends StatelessWidget {
  pageAddpost({super.key});
      ...
      body: BlocListener<PostBloc, PostState>(
          listener: (context, state) {
            ...
            if (state.status == PostStatus.success) {
              ...
              print("Error creating post: ${state.errorMessage}"); // Debugging line
                        ...
                        child: state.images.isEmpty
                            ...
                            : GridView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  print("Image path: ${state.images[index]}"); // Debugging line
                                  return Stack(
                                    children: [
                                      ClipRRect(
